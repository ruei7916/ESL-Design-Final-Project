...
class AES128 : public sc_module{
public:
  sc_in_clk i_clk;
  sc_in<bool> i_rst;
#ifndef NATIVE_SYSTEMC
	cynw_p2p< sc_biguint<128> >::in key_in;
  cynw_p2p< sc_biguint<128> >::in plaintext_in;
	cynw_p2p< output_t >::out dout;
#else
	sc_fifo_in< sc_biguint<128> > key_in;
  sc_fifo_in< sc_biguint<128> > plaintext_in;
	sc_fifo_out< output_t > dout;
#endif
...
private:
  ...
  StateBlock state;
  //sc_biguint<128> GenerateRoundKey(sc_uint<4> RoundNum, sc_biguint<128> prevRoundKey);
  ...
  //void ShiftRow(unsigned char state[4][4], unsigned int i, unsigned int n);  // shift row i on n positions
...
static const sc_uint<2> CMDS[4][4] = {
